...
{
if(columnIndex==0) return Integer.class; //it is a special treatment statement it will become return Class.forName("java.lang.Integer")
return String.class;
}
...
fireTableDataChanged(); //to quickly changed data from JTable as new data added
}

public int indexOfDesignation(DesignationInterface designation) throws BLException //this method will be used for getting index of new added designation to highlight that
{
...
//creating footer
doc.add(dataTable);
doc.add(new Paragraph("Software by: Mohit Namdev"));
