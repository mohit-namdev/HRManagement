//after compiling this to run this we will run 
//java -classpath ..\common\dist\hr-common.jar;..\dl\dist\hr-dl-1.0.jar;..\bl\build\libs\bl.jar;build\libs\pl.jar;. com.thinking.machines.hr.pl.Main
//in command prompt
...
clearIcon=new ImageIcon("c:"+File.separator+"JavaProjects"+File.separator+"hr"+File.separator+"icons"+File.separator+"clear.png");
...
searchTextField.setBounds(lm+10+100+10,tm+10+40+10,400,30);
clearSearchTextFieldButton.setBounds(lm+10+100+10+400+10,tm+10+40+10,45,30);
searchErrorLabel.setBounds(lm+10+100+10+400+10-80,tm+10+40+10-23,100,30);
scrollPane.setBounds(lm+10,tm+10+40+10+30+10,567,300);
designationPanel.setBounds(lm+10,tm+10+40+10+30+10+300+10,565,195);
...
clearTitleTextFieldButton.setBounds(lm+10+110+5+350+5,tm+20,45,30);
